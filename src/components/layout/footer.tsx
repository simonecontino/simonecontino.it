  ...
  return (
    <footer className="site-footer">
      <Container className="footer-grid">
        ...
        <div><strong>Note legali</strong><Link href="/privacy">Privacy policy</Link><Link href="/cookie-policy">Cookie policy</Link><p className="footer-note">I contenuti informativi non sostituiscono una valutazione medica.</p></div>
      </Container>
